...
const RFIDLabelPrinting = () => {
  ...
  const handlePreview = () => {
    ...
    toast({
      ...
      description: `${quantity} RFID labels ready for printing`,
    });
  };
  ...
  const handlePrint = () => {
    ...
    toast({
      ...
      description: `Printing ${previewData.length} RFID labels...`,
    });
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Successfully printed ${previewData.length} RFID labels`,
      });
    }, 2000);
  };
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold tracking-tight">RFID Label Printing</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Preview of RFID labels to be printed
            </CardDescription>
          </CardHeader>
          <CardContent>
            {previewData.length > 0 ? (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  {previewData.slice(0, 6).map((binId, index) => (
                    ...
                    >
                      <div className="text-xs text-gray-500 mb-1">RFID Bin Label</div>
              ...
              <div className="h-[300px] flex flex-col items-center justify-center text-muted-foreground">
                <Printer className="h-16 w-16 mb-4 text-muted" />
...
export default RFIDLabelPrinting;
